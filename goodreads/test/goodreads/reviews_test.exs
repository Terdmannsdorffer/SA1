defmodule Goodreads.ReviewsTest do
  ...
  describe "reviews" do
    ...
    import Goodreads.ReviewsFixtures

    @invalid_attrs %{review: nil, score: nil, number_of_up_votes: nil}
    ...
    test "update_review/2 with valid data updates the review" do
      review = review_fixture()
      update_attrs = %{review: "some updated review", score: 43, number_of_up_votes: 43}
      ...
      assert review.number_of_up_votes == 43
    end
